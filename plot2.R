...
# Create the line time series plot for Global Active Power: 
    with(data, plot(Global_active_power~date_and_time, type = "l", ylab = "Global Active Power (Kilowatts)", xlab="" ))
